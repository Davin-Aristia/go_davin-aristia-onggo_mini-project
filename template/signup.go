...
func RenderSignupTemplate(date, name string) (string, error) {
    ...
    <body>
        <div class="container">
            ...
            <p>Hello, {{.Name}}</p>
            <p>Your Book Store API account was created on {{.Date}}.</p>
    ...
    `
    tmpl, err := template.New("signupTemplate").Parse(signupTemplate)
    if err != nil {
        return "", err
    }
